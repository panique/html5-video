...
<video controls="controls" poster="img/demo.jpg" width="640" height="360">
    ...
    <object type="application/x-shockwave-flash" data="swf/flowplayer-3.2.18.swf" width="640" height="360">
        ...
        <param name="flashVars" value="config={'playlist':['..%2Fimg%2Fdemo.jpg',{'url':'..%2Fvid%2Fdemo.mp4','autoPlay':false}]}" />
        <!-- fallback image if flash fails -->
        <img src="img/demo.jpg" width="640" height="360" title="No video playback capabilities found" />
    </object>
</video>
```
